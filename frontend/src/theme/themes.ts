...
const lightBrutalist: Theme = {
  ...
  Radii: { card: 6, button: 6, input: 6, pill: 6, small: 4, xs: 2, handle: 2, icon: 6, circle: 9999 },
  Shadows: {
...
const light: Theme = {
  ...
  Radii: { card: 12, button: 10, input: 10, pill: 20, small: 6, xs: 4, handle: 3, icon: 10, circle: 9999 },
  Shadows: {
    card: {
      shadowColor: '#000',
...
const highContrast: Theme = {
  ...
  Radii: { card: 4, button: 4, input: 4, pill: 4, small: 2, xs: 1, handle: 1, icon: 4, circle: 9999 },
  Shadows: {
