...
// Stations and equipment types are now backend rows (GET /stations, GET /equipment-types) rather
// than fixed enums. Navigation only carries the human-readable station name and the kind of
// equipment being reported; the concrete equipment row (and its id) is resolved on the report screen.
